    ...
    <div class="mx-auto my-10 max-w-md rounded-xl border px-4 py-10 text-gray-700 shadow-lg sm:px-8">
      <div class="mb-16 flex justify-between">
        <span class="font-bold">
          <span class="inline-block h-3 w-3 bg-orange-600"></span> StableBilling
        </span>
        <span class="">
          Have account?{" "}
          <Link
      ...
      <p class="mb-5 text-3xl font-medium">
        SignUp & Manage your Business with us!
      </p>
      <p class="mb-6 text-sm">
        Efficiency meets accuracy: Master your business with our billing and
        inventory app.
      </p>
          ...
          <div className="space-y-5">
            ...
            >
              <div className="flex flex-row">
                <div
                  class={` ${toogle ? "visible" : "hidden"} text-center mx-2`}
                >
                  <div role="status">
                    <svg
                      aria-hidden="true"
                      class="inline w-5 h-5  text-gray-200 animate-spin dark:text-orange-600 fill-white"
                      viewBox="0 0 100 101"
                      fill="none"
